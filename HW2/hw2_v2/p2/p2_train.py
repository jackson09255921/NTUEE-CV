...
def plot_learning_curve(
    ...
    # Train Accuracy
    plt.figure()
    plt.plot(result_lists['train_acc'], label='Train Accuracy', color='blue')
    plt.xlabel('Epoch')
    plt.ylabel('Accuracy')
    ...
    # Train Loss
    plt.figure()
    plt.plot(result_lists['train_loss'], label='Train Loss', color='red')
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
    ...
    # Validation Loss
    plt.figure()
    plt.plot(result_lists['val_loss'], label='Validation Loss', color='orange')
    plt.xlabel('Epoch')
    plt.ylabel('Loss')
